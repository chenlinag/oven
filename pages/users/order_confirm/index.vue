<template>
	<view :style="viewColor">
		<view class='order-submission'>
			<view v-if="allow_address" class="allAddress" @click="onAddress">
	...
	export default {
		...
		methods: {
			...
			onAddress: function() {
				...
				that.pagesUrl = '/pages/users/user_address_list/index?cartId=' + this.cartId + '&pinkId=' + this.pinkId + '&couponId=' + this.couponId;
			},
			/**
			 * 开发票
			 */
