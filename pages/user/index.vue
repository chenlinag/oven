					...
					<view class="user-info">
						...
						<view class="info">
							...
							<view class="num" v-if="userInfo.phone" @click="goEdit()">
								...
								<view class="num-txt">我的ID：{{userInfo.uid}}</view>
								<view class="icon">
									<image src="/static/images/edit.png" mode=""></image>
								</view>
								<view class="num-txt"> 推荐人ID：{{userInfo.spread_uid}}</view>
								<view class="icon">
									<image src="/static/images/edit.png" mode=""></image>
								</view>
								<view class="num-txt">会员等级：V{{userInfo.member_level}}</view>
							</view>
